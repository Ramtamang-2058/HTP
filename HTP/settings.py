"""
Django settings for HTP project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-e0dzbbrmafwt!7!p#375#yv$6u8$in3*of=%gto+**nqdmcy(s')
...
# WhiteNoise serves STATIC_ROOT files directly from Django (compressed,
# cache-headers) — reliable under Passenger regardless of Apache config.
STORAGES = {
    'default': {
